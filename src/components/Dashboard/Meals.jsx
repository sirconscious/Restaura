...
const MealAvailabilityUpdate = () => {
  ...
  useEffect(() => {
    ...
    const fetchMeals = async () => {
      try {
        const response = await axios.get('http://localhost/bibilo_crud/test3/fetchMeals.php');
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost/bibilo_crud/test3/UpdateMeals.php', {
