...
const Sidebar = () => {
  ...
  return (
    <aside className="bg-white p-5 shadow-md w-64">
      <button onClick={toggleSidebar} className="lg:hidden p-2 text-gray-800">
        <FiMenu size={24} />
      </button>

      <div className={`${isSidebarOpen ? "block" : "hidden"} md:block`}>
        <h1 className="text-lg font-bold text-center mb-10 relative">
          Riad Saveur
        </h1>
        <ul className="space-y-4">
          <li>
            <a
              href="#dashboard"
              className="flex items-center p-3 text-gray-800 rounded-lg hover:bg-gray-100"
            >
